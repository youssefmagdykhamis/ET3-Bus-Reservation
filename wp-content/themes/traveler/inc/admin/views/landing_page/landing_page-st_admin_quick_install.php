                        ...
                        <div class="theme">
                            ...
                            <div class="theme-actions-demo">
                                <ul class="theme-name" id="classic" style="display: flex;justify-content: space-between;height: 27px;">
                                    ...
                                    <li><a onclick="return false" class="button button-primary st-quick-install-demo" data-style="elementor" data-demo-id="<?php echo esc_attr($key) ?>" href="#"><?php _e('Install','traveler')?></a></li>
                                </ul>
