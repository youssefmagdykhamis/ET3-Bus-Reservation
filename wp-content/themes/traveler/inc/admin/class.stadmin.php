        ...
        function run_crate_mail(){
            ...
            if(get_option('check_mail',0) == 1){
                ...
                $arr_key_mail =[
                    ...
                    'partner_email_for_customer' => '[Register] Email to customer',
                    'partner_email_approved' => '[Register] Email to partner',
                    ...
                    'send_user_new_request_withdrawal' => '[Request] Email to user withdrawal',
                    'send_user_approved_withdrawal' => '[Approved] Email to user withdrawal',
                    ...
                    'email_approved' => 'Email template for approve send to administrator',
