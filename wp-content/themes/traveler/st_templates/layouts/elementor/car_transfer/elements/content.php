...
<div class="col-lg-9 col-md-9">
    <?php echo st()->load_template('layouts/elementor/hotel/elements/toolbar', '', array('style' => $style, 'format' => $format, 'layout' => $layout, 'service_text' => __('New car', 'traveler'), 'post_type' => 'st_car_transfer')); ?>
