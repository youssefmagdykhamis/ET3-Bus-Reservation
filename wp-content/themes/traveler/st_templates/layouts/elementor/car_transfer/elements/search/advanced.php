...
<div class="form-button st-cartransfer-advance d-flex align-items-center justify-content-between">
    <div class="advance dropdown">
        <div class="form-group form-extra-field field-advance">
            <div class="dropdown-toggle"  id="dropdown-advance" type="button"  data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        ?>
                            ...
                            <div class="item-content">
                                <div class="st-number d-flex align-items-center">
