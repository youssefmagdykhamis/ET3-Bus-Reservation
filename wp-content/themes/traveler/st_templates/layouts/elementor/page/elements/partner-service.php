                ...
                while ($query->have_posts()) {
                    ...
                    switch ($service) {
                        ...
                        case "tours":
                            ...
                            break;
                        case "activity":
                            echo st()->load_template('layouts/elementor/activity/elements/loop/grid');
                            break;
                        case "cars":
                            echo st()->load_template('layouts/elementor/car/elements/loop/grid');
                            break;
                        case "rental":
                            echo '<div class="col-lg-4 col-md-6 col-xs-6">';
                            echo st()->load_template('layouts/elementor/rental/elements/loop/grid');
                            echo '</div>';
                            break;
                        case "flight":
