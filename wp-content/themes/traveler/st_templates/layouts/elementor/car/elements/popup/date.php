<?php
?>
<div class="st-popup popup-date d-sm-none d-md-none" data-date-format="<?php echo TravelHelper::getDateFormatMoment() ?>" data-time-format="hh:mm A" data-format="<?php echo TravelHelper::getDateFormatMoment() ?>, hh:mm A">
