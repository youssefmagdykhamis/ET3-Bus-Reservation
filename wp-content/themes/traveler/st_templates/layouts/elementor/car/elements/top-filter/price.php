...
<li class="filter-price">
    <div class="form-extra-field dropdown">
        <button class="btn btn-link dropdown-toggle" type="button" id="dropdownMenuFilterPrice" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
