        ...
        <div class="container">
            <div class="st-results st-hotel-result">
                <div class="row">
                    <?php
                    if($sidebar_pos == 'left') {
                        echo st()->load_template('layouts/elementor/hotel/elements/sidebar', '', array('format' => 'popupmap'));
                    }
                    ?>
                    <?php
                    $query           = array(
                    ...
                    echo st()->load_template('layouts/elementor/hotel/elements/content3');
                    echo st()->load_template('layouts/elementor/hotel/elements/popupmap');
